...
export default class Socket {
  constructor(onConnected, onMessage, onSystemMessage, onRoomData, onReceiveError) {
  ...
  requestSetSpawnDelay = (value) => this.socket.emit(Protocol.SET_SPAWN_DELAY, value)
  requestSetMaxWordLength = (value) => this.socket.emit(Protocol.SET_MAX_WORD_LENGTH, value)
  requestSetMinWordLength = (value) => this.socket.emit(Protocol.SET_MIN_WORD_LENGTH, value)
  requestSetPowerups = (value) => this.socket.emit(Protocol.SET_POWER_UPS, value)
  requestSetAllowSpectate = (value) => this.socket.emit(Protocol.SET_ALLOW_SPECTATORS, value)
}
